...
frame = tk.Frame(master=window, bg="grey", padx=200,pady=300)
frame.pack()
...
button_eq = tk.Button(master=frame, text='=', padx=20, pady=5, width=3, command=lambda: calculate())
button_eq.grid(row=5, column=1, pady=2)
...
button_modu = tk.Button(master=frame, text='%', padx=25, pady=5, command=lambda:addButton('%'))
button_modu.grid(row=6, column=0, columnspan=3, pady=2)
